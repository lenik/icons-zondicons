...
.\build.ps1 -Name icons-zondicons -Version 1.2.3
```
...
```
<project>/.config/icons-zondicons/<packaging>.build-host
$HOME/.config/icons-zondicons/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-zondicons
```
